...
st = read('C:/Users/clayp/Desktop/Popo_data_09152021/POTO/*')
st.merge(method='1')
st2 = read('C:/Users/clayp/Desktop/Popo_data_09152021/PITO/*')
st2.merge(method='1')
st.append(st2[0])
...
ti = UTCDateTime('2021-09-15T11:36:18')
print(ti)
